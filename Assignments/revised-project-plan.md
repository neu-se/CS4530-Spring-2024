...
# Revised Project Plan **Due Wednesday February 28, 11:00am ET**{: .label .label-red }
...
**EACH CONDITION OF SATISFACTION MUST HAVE A PRIORITY (Essential, Desirable, or Optional). EACH USER STORY MUST HAVE SOME ESSENTIAL AND/OR DESIRABLE CONDITIONS OF SATISFACTION**.  The set of essential items will constitute the "Minimum Viable Product". Each user story should include one or more essential and desirable conditions of satisfaction.
